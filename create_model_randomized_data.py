...
model_name='5_layer_3_fields_2drop_3l1_5000nodes'
#sess = tf.Session()
#%% =============================================================================
# Load data
# =============================================================================
...
model_data_T=np.load(store_folder+'COSMO_daily_mean_dd_T_2M_random.npy')
model_data_RH=np.load(store_folder+'COSMO_daily_mean_RELHUM_2M_random.npy')
...
if __name__=='__main__':
    ...
    '''
    model = tf.keras.Sequential([
        tf.keras.layers.Dense(5000,activation=tf.nn.relu,input_shape=(single_field_index*3,)),
        tf.keras.layers.Dense(5000, activation=tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l1(0.001)),
        tf.keras.layers.Dropout(0.5),
        tf.keras.layers.Dense(5000, activation=tf.nn.relu,kernel_regularizer=tf.keras.regularizers.l1(0.001)),
        tf.keras.layers.Dropout(0.5),
        tf.keras.layers.Dense(5000, activation=tf.nn.relu,kernel_regularizer=tf.keras.regularizers.l1(0.001)),
...
#    optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.02)
    optimizer=tf.train.RMSPropOptimizer(0.000002)
